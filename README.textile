...
bc(ruby). Rails.application.resources['post_comments']

p. Controllers get a @resource@ instance method to controllers returning the resource they are handling, if any.
